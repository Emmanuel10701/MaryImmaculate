...
export default function StaffProfilePage() {
  ...
  const schoolDescription = "Mary immaculate girls High School provides exceptional education through trained professionals dedicated to holistic student development and academic excellence.";
...
const transformStaffData = (apiData) => {
  ...
  return {
    ...
    bio: apiData.bio || `A committed educator at  Mary Immaculate girls High School with a passion for student success and educational excellence.`,
    expertise: expertise,
  ...
  const SeoHead = () => {
    ...
    const profileTitle = `${staff.name} - ${staff.position} at Mary  Immaculate Girls Secondary School`;
    const profileDescription = staff.bio || `Meet ${staff.name}, ${staff.position} at Mary Immaculate Girls Secondary School. ${schoolDescription}`;
    const profileUrl = typeof window !== 'undefined' ? window.location.href : `https://maryimmaculate.edu.ke/staff/${staff.id}`;
    ...
    return (
      <>
        ...
        <meta name="keywords" content={`${staff.name}, ${staff.position}, Mary Immaculate Girls Secondary School, teacher profile, ${staff.department}`} />
        <meta name="author" content="Mary Immaculate Girls Secondary School" />
        ...
        <meta property="og:site_name" content="Mary Immaculate Girls Secondary School" />
        ...
        <meta property="twitter:site" content="@MaryImmaculateGS" />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "worksFor": {
                ...
                "url": "https://maryimmaculate.edu.ke"
              },
...
const ShareModal = () => {
  ...
  const shareText = `Check out ${staff.name}'s profile - ${staff.position} at Mary Immaculate Girls Secondary School `;
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white w-full max-w-sm rounded-[2.5rem] shadow-3xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="bg-slate-50 p-4 text-center">
          <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Mary Immaculate Girls Secondary School</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
      ...
      <div className="space-y-3">
        ...
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest max-w-[200px] leading-relaxed">
          Mary Immaculate Girls Secondary School  Professional Directory
        </p>
      </div>
        ...
        <div className="bg-white/90 backdrop-blur-sm border-b border-gray-200/50 sticky top-0 z-40 sm:bg-white/80">
          <div className="max-w-7xl mx-auto px-4 h-14 sm:h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-bold text-gray-800 hidden sm:block md:hidden">MIGS</span>
              <span className="font-bold text-gray-800 hidden md:block lg:hidden">Mary Immaculate</span>
              <span className="font-bold text-gray-800 hidden lg:block">Mary Immaculate Girls Secondary School</span>
            </div>
...
<div className="relative w-20 h-20 sm:w-28 sm:h-28 lg:w-40 lg:h-40 xl:w-56 xl:h-56 rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden border-3 sm:border-4 border-white/30 sm:border-white/40 shadow-md sm:shadow-2xl">
  {staff.image && staff.image.startsWith('http') ? (
    <img
      src={staff.image}
      alt={`Professional portrait of ${staff.name} - ${staff.position} at Mary Immaculate Girls Secondary School`}
  ...
  <div className="md:col-span-4 space-y-4 sm:space-y-6 lg:space-y-8">
    ...
    <div className="bg-slate-900 rounded-[2rem] p-6 text-white relative overflow-hidden group shadow-2xl">
      ...
      <div className="relative z-10 flex items-center gap-4 mb-4">
        ...
        <div>
          <h3 className="font-black text-xs uppercase tracking-widest leading-tight"> Mary Immaculate Girls Secondary School</h3>
    ...
    <div className="flex flex-col items-center justify-center space-y-6">
      ...
      <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-slate-400">
        ...
        <p className="text-[10px] sm:text-xs font-black uppercase tracking-tighter text-slate-300">
          © {new Date().getFullYear()}  Mary Immaculate Girls Secondary School
        </p>
      </div>
